...
if(winsComputer > winsUser){
  console.log(`O computador teve ${winsComputer} vitórias e você teve ${winsUser} vitórias, portanto o computador foi campeão!`);
}else if(winsComputer < winsUser){
  console.log(`Você teve ${winsUser} vitórias e o computador teve ${winsComputer} vitórias, portanto você foi o campeão!`);
}else if(winsComputer==winsUser){
  console.log(`Você teve ${winsUser} vitórias e o computador teve ${winsComputer} vitórias, portanto, temos um empate!`);
}